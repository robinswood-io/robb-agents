...
class InstallerContractTests(unittest.TestCase):
    ...
    def test_platform_builds_use_the_bun_workspace_executor(self) -> None:
        ...
        self.assertIn("--local-production", mac_build)
        self.assertIn("LOCAL_PRODUCTION_BUILD=true", mac_build)
        self.assertIn("~/.craft-agent and must never be distributed", mac_build)
