# v0.11.3 — Release Pipeline & Autonomous Execution Hardening

This release consolidates the latest Robb Agents packaging, installer, update and autonomous-execution improvements into a signed public build.
