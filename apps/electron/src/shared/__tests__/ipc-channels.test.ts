...
const EXPECTED_CHANNELS: string[] = [
  ...
  'fs:search',
  'gemini:cancelOAuth',
  'gemini:completeOAuth',
  'gemini:getAuthStatus',
  'gemini:logout',
  'gemini:startOAuth',
  'git:getBranch',
  'gitbash:browse',
  ...
  'missions:cancel',
  'missions:changed',
  'missions:createAndStart',
  'missions:get',
  'missions:getPlan',
  'missions:getProofPassport',
  'missions:getProofPassportTrustAnchor',
  'missions:list',
  'missions:listConnectorApprovals',
  'missions:pause',
  'missions:plan',
  'missions:planned',
  'missions:preflight',
  'missions:previewReplan',
  'missions:refreshConnectorApproval',
  'missions:replan',
  'missions:resolveConnectorApproval',
  'missions:resume',
  'missions:verifyProofPassport',
  ...
  'oauth:revoke',
  'oauth:start',
  'onboarding:cancelMistralVibeSetup',
  'onboarding:clearClaudeOAuthState',
  'onboarding:completeMistralVibeSetup',
  ...
  'sessions:watchFiles',
  'settings:createRemotePairing',
  'settings:getDefaultThinkingLevel',
  'settings:getNetworkProxy',
  'settings:getServerConfig',
  'settings:getServerStatus',
  'settings:listRemoteDevices',
  'settings:revokeRemoteDevice',
  ...
  'tasks:generated',
  'tasks:get',
  'tasks:getCockpitProjections',
  'tasks:getKillSwitches',
  'tasks:getOutput',
  'tasks:getResults',
  'tasks:list',
  'tasks:listApprovals',
  ...
  'workspaceSettings:analyzeRoutingShadow',
  'workspaceSettings:get',
  'workspaceSettings:governanceUpdate',
  'workspaceSettings:remoteSupervisionGrant',
  'workspaceSettings:remoteSupervisionRevoke',
