...
export const CHANNEL_MAP = {
  ...
  repairTask: invoke(RPC_CHANNELS.tasks.REPAIR),
  ...
  listDurableTasks: invoke(RPC_CHANNELS.tasks.LIST_DURABLE),
  updateTaskMetadata: invoke(RPC_CHANNELS.tasks.UPDATE_METADATA),
  ...
  preflightMission: invoke(RPC_CHANNELS.missions.PREFLIGHT),
  previewMissionReplan: invoke(RPC_CHANNELS.missions.PREVIEW_REPLAN),
  replanMission: invoke(RPC_CHANNELS.missions.REPLAN),
  getMission: invoke(RPC_CHANNELS.missions.GET),
  listMissions: invoke(RPC_CHANNELS.missions.LIST),
  listMissionConnectorApprovals: invoke(RPC_CHANNELS.missions.LIST_CONNECTOR_APPROVALS),
  resolveMissionConnectorApproval: invoke(RPC_CHANNELS.missions.RESOLVE_CONNECTOR_APPROVAL),
  refreshMissionConnectorApproval: invoke(RPC_CHANNELS.missions.REFRESH_CONNECTOR_APPROVAL),
  getMissionProofPassport: invoke(RPC_CHANNELS.missions.GET_PASSPORT),
  getMissionProofPassportTrustAnchor: invoke(RPC_CHANNELS.missions.GET_PASSPORT_TRUST_ANCHOR),
  verifyMissionProofPassport: invoke(RPC_CHANNELS.missions.VERIFY_PASSPORT),
