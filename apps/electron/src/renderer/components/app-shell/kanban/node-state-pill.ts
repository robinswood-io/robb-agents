...
// (packages/shared/src/tasks/storage.ts): pending | waiting-approval | running | done | failed | cancelled | skipped.
...
const NODE_STATE_PILL: Record<string, string> = {
  ...
  'waiting-approval': 'border-indigo-500/30 bg-indigo-500/[0.06] text-indigo-600 dark:text-indigo-300',
