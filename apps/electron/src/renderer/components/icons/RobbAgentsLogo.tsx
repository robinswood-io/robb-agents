      ...
      <svg viewBox="0 0 340 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
        <g transform="translate(0 0)">
          <path
            ...
            fill="currentColor"
          />
          <path d="M4 54.5c12.7-4.3 23.2-4.1 32-.8 3.2 1.2 6.1 1.8 8.8 1.8" stroke="#E0796B" strokeWidth="5" strokeLinecap="round" />
          <circle cx="40.5" cy="13.5" r="4.5" fill="#E0796B" />
        </g>
        <text x="62" y="34" fill="currentColor" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="27" fontWeight="700" letterSpacing="-1.2">ROBB</text>
        <text x="62" y="54" fill="currentColor" opacity=".7" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="14" fontWeight="600" letterSpacing="3.3">AGENTS</text>
      </svg>
    </div>
  )
}
