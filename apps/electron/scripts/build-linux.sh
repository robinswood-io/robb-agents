...
echo "=== Building Robinswood Agents AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Robinswood-Agents-x86_64.AppImage or Robinswood-Agents-aarch64.AppImage
BUILT_APPIMAGE_NAME="Robinswood-Agents-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Robinswood-Agents-x64.AppImage, Robinswood-Agents-arm64.AppImage
APPIMAGE_NAME="Robinswood-Agents-${ARCH}.AppImage"
