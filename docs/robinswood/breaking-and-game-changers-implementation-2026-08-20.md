...
Ce document trace l'implémentation locale de l'audit « breaking changes et game changers » pour Robb Agents 0.12.2. Il distingue trois niveaux de preuve :
...
- installation verrouillée et contrat de versions : verts, version workspace `0.12.2` sur 15 paquets;
- TypeScript natif 7 : 16/16 configurations vertes; matrice API TypeScript 6 : 16/16 verte;
- suite exhaustive après les derniers correctifs : 5 833 tests réussis, 12 ignorés, 0 échec, 14 376 assertions, 5 845 tests dans 528 fichiers;
- `validate:ci` : vert, dont 48/48 contrats de release, audits de paquet, outils documentaires, installateurs et parité i18n (7 locales plus l'anglais, 2 047 clés chacune);
...
- lint global : zéro erreur et 218 avertissements historiques non bloquants (Electron 119, shared 12, server-core 87, UI 0);
