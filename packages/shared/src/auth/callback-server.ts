 ...
 */
function tryBind(server: Server, port: number, host = 'localhost'): Promise<void> {
...
export interface CreateCallbackServerOptions {
  ...
  /** Host to bind and advertise. Defaults to 'localhost'. Google desktop OAuth prefers '127.0.0.1'. */
  host?: string;
}
