...
export const RPC_CHANNELS = {
  ...
  tasks: {
    ...
    GET: 'tasks:get',
    LIST: 'tasks:list',
    LIST_DURABLE: 'tasks:listDurable',
    UPDATE_METADATA: 'tasks:updateMetadata',
    GET_COCKPIT_PROJECTIONS: 'tasks:getCockpitProjections',
  ...
  missions: {
    ...
    PREFLIGHT: 'missions:preflight',
    PREVIEW_REPLAN: 'missions:previewReplan',
    REPLAN: 'missions:replan',
    GET: 'missions:get',
    LIST: 'missions:list',
    LIST_CONNECTOR_APPROVALS: 'missions:listConnectorApprovals',
    RESOLVE_CONNECTOR_APPROVAL: 'missions:resolveConnectorApproval',
    REFRESH_CONNECTOR_APPROVAL: 'missions:refreshConnectorApproval',
    GET_PASSPORT: 'missions:getProofPassport',
    GET_PASSPORT_TRUST_ANCHOR: 'missions:getProofPassportTrustAnchor',
    VERIFY_PASSPORT: 'missions:verifyProofPassport',
  ...
  gemini: {
    START_OAUTH: 'gemini:startOAuth',
    COMPLETE_OAUTH: 'gemini:completeOAuth',
    CANCEL_OAUTH: 'gemini:cancelOAuth',
    GET_AUTH_STATUS: 'gemini:getAuthStatus',
    LOGOUT: 'gemini:logout',
  },
  settings: {
