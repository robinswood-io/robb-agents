...
const REMOTE_DEVICE_WORKSPACE_ARGUMENTS = new Map<string, number>([
  ...
  [RPC_CHANNELS.tasks.LIST_DURABLE, 0],
  [RPC_CHANNELS.tasks.UPDATE_METADATA, 0],
  [RPC_CHANNELS.tasks.GET_COCKPIT_PROJECTIONS, 0],
  [RPC_CHANNELS.tasks.GET_RESULTS, 0],
  [RPC_CHANNELS.missions.GET, 0],
  [RPC_CHANNELS.missions.GET_PLAN, 0],
  [RPC_CHANNELS.missions.LIST, 0],
  [RPC_CHANNELS.missions.PREFLIGHT, 0],
  [RPC_CHANNELS.missions.PREVIEW_REPLAN, 0],
  [RPC_CHANNELS.missions.REPLAN, 0],
  [RPC_CHANNELS.missions.LIST_CONNECTOR_APPROVALS, 0],
  [RPC_CHANNELS.missions.RESOLVE_CONNECTOR_APPROVAL, 0],
  [RPC_CHANNELS.missions.REFRESH_CONNECTOR_APPROVAL, 0],
  [RPC_CHANNELS.missions.GET_PASSPORT, 0],
  [RPC_CHANNELS.missions.GET_PASSPORT_TRUST_ANCHOR, 0],
  [RPC_CHANNELS.missions.VERIFY_PASSPORT, 0],
  [RPC_CHANNELS.missions.PAUSE, 0],
  [RPC_CHANNELS.missions.RESUME, 0],
  [RPC_CHANNELS.missions.CANCEL, 0],
  ...
  [RPC_CHANNELS.workspace.ROUTING_SHADOW_ANALYZE, 0],
